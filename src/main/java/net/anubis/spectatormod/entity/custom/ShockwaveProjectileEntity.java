...
public class ShockwaveProjectileEntity  extends ThrownItemEntity {
    public ShockwaveProjectileEntity(EntityType<? extends ThrownItemEntity> entityType, World world) {
        super(entityType, world);
    }

    public ShockwaveProjectileEntity(LivingEntity livingEntity, World world) {
        super(ModEntities.THROWN_SHOCKWAVE_PROJECTILE, livingEntity, world);
    }
    ...
    private static final TrackedData<Boolean> HIT =
            DataTracker.registerData(ShockwaveProjectileEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
